...
@connect(state => {
	const transientValues = selectors.UI.Inspector.transientValues(state);
...
export default class AnchorView extends Component {
	...
	getSetionId = () => {
		return this.props.transientSectionId || this.props.focusedNode ? this.props.focusedNode.properties.sectionId : false;
	}

	copyToClipboard = () => {
		const documentNodeIdentifier = this.props.documentNode.identifier;
